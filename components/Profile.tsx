...
import { View, Dimensions, StyleSheet, Image, Text, TouchableOpacity, ScrollView, FlatList, Modal } from 'react-native';
...
const profileInfo = {
  '1': {
    ...
    profileVid: idol,
    skills: ['Guitar', 'Fl studio', 'Mixing'],
    ...
    projects: [
        { id: '1', title: 'Midsummer madness', snippet: idol },
        { id: '2', title: 'Song #2', snippet: joyangVideo },
    ],
  ...
  return (
    <ScrollView style={styles.container}>
      {selectedProfile && (
        <>
          <Video
            source={selectedProfile.profileVid ? selectedProfile.profileVid : { uri: 'https://www.w3schools.com/html/mov_bbb.mp4' }}
            style={styles.video}
